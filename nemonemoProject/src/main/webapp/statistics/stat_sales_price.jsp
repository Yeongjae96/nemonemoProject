            ...
            <div class="container-fluid">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12  m-p-0" >
                            <h4 class="col-lg-2 col-md-2 col-sm-2 col-xs-2">금액검색</h4>
                            <div class="m-b-0 col-lg-2 col-md-2 col-sm-2 col-xs-2 m-p-0">
                                <div class="input-group date" id="sales_product_prev">
                                    <div class="form-line">
                        ...
                        <div></div>
                        <div class="clearfix"></div>
                        <h4 class="col-lg-3 col-md-3 col-sm-3 col-xs-3"><span class="red">2020</span>년 <span class="red">07</span>월 <span class="red">20</span>일</h4>
...
<!-- 		<script src="bluebird.min.js"></script>
		...
		<script src="<c:url value ="/resources/js/admin/statistics/stat_sales_price.js"/>"></script>
