			...
			<div class="row clearfix">
				<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
					<div class="card">
						...
						<div class="body">
							<form id="reportCategoryEditForm" method="POST" action="edit.mdo">
								
								  <div class="form-group form-float" style="margin-top: 30px;">
                                    <label class="form-label">사용 여부</label>
                                    <select class="selectpicker" id="reportCategoryUseFl" name="reportCategoryUseFl">
                                        <option value="Y" <c:if test="${reportCategoryVO.reportCategoryUseFl eq 'Y'}">selected</c:if>>Y</option>
                                        <option value="N" <c:if test="${reportCategoryVO.reportCategoryUseFl eq 'N'}">selected</c:if>>N</option>
                                    </select>
                                </div>
