...
<body class="theme-red">
					...
					<div class="table-responsive" style="overflow-x: hidden;">
						<div class="category-flex">
							<button type="button" class="btn bg-pink waves-effect m-r-20"
								data-toggle="modal" data-target="#registryModal">카테고리
								등록</button>
							<button type="button" class="btn bg-pink waves-effect m-r-20">카테고리
								수정</button>
							<button type="button" class="btn bg-pink waves-effect m-r-20">카테고리
								삭제</button>
						...
						<table
							class="table table-bordered table-striped table-hover category-table">
							<thead>
								<tr>
									<th>카테고리 코드</th>
									<th>대분류</th>
								...
								<div class="modal-row--content">
									<div class="input-group input-group-lg">
										<span class="input-group-addon"> <input type="radio"
											class="with-gap" id="lg-category" name="categoryType"
											value="1"> <label for="lg-category">대분류</label>
										</span> <span class="input-group-addon"> <input type="radio"
											class="with-gap" id="md-category" name="categoryType"
											value="2"> <label for="md-category">중분류</label>
										</span> <span class="input-group-addon"> <input type="radio"
											class="with-gap" id="sm-category" name="categoryType"
											value="3"> <label for="sm-category">소분류</label>
										</span>
									</div>
								</div>
							</div>
	...
	<!-- 개인 JS -->
	<script
		src="<c:url value ="/resources/js/admin/sites/site_category_list.js"/>"></script>
	<script
		src="<c:url value ="/resources/vendor/pages/tables/jquery-datatable.js"/>"></script>
	<!-- ??? -->
