...
<!-- 개인 CSS -->
<link rel="stylesheet"
	href="<c:url value="/resources/css/admin/sites/site_notice_list.css"/>">
...
<body class="theme-red">
					...
					<div class="table-responsive" style="overflow-x: hidden;">
							...
							<tbody id="result">
								<c:forEach var="notice" items="${noticeList}">
									<tr>
										...
										<td><textarea style="width: 100%;">${notice.noticeContent}
                                        </textarea></td>

										<td>${notice.noticeRegistryYmd}</td>
										<td>${notice.noticeModifyYmd}</td>
										<td class="text-center"><button type="button"
												class="notice-upd-btn" data-noticeNo="${notice.noticeNo}">수정</button>

											<button type="button" class="notice-del-btn"
												data-noticeNo="${notice.noticeNo}">삭제</button></td>
									</tr>
									<!-- <tr>
                                        <td>공지1</td>
                                        <td>
						...
						<div class="notice-flex">
							<button type="button" class="btn bg-pink waves-effect m-r-20"
								data-toggle="modal" data-target="#notice_in">공지사항 등록</button>
						</div>
					</div>
					<!-- 등록 수정 분류-->
					...
					<div class="modal-content">
							...
							<form method="POST" action="new.mdo" name="noticeForm">
								<div class="form-group">
									<div class="notice-registry--title">
										<label for="InputNoticeName">공지사항 제목</label> <input
									...
									<textarea class="form-contr ol" id="noticeContent"
										name="noticeContent" placeholder="내용을 입력해주세요"></textarea>
								</div>
							</form>
						</div>
						...
						<div class="modal-footer">
							<button type="button" class="btn btn-success"
								data-dismiss="modal" id="NoticeInsert">등록</button>
	...
	<!-- 개인 JS -->
	<script
		src="<c:url value ="/resources/js/admin/sites/site_notice_list.js"/>"></script>
