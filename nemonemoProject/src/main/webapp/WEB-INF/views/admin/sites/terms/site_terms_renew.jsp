	...
	<section class="content">
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form id="termsRenewForm" method="POST" action="renew.mdo">
                                <div class="form-group form-float">
                                   ...
                                   <select class="selectpicker" id="termsTitle" name="termsTitle" disabled="disabled">
                                    	<option value="S" <c:if test="${termsVO.termsTitle eq 'S'}">selected</c:if>>이용약관</option>
                                        <option value="P" <c:if test="${termsVO.termsTitle eq 'P'}">selected</c:if>>개인정보처리방침</option>
                                        <option value="L" <c:if test="${termsVO.termsTitle eq 'L'}">selected</c:if>>위치기반서비스 이용약관</option>
                                    </select>
                                </div> 
                                </div>
                                <div class="form-group form-float">
                               ...
                               <div class="form-group form-float" style="margin-top: 30px;">
                                    ...
                                    <select class="selectpicker" id="termsRequiredFl" name="termsRequiredFl" disabled="disabled">
                                ...
                                <div class="form-group form-float" style="margin-top: 30px;">
                                    ...
                                    <select class="selectpicker" id="termsDeleteFl" name="termsDeleteFl" disabled="disabled">
                                ...
                                <button class="btn btn-primary waves-effect" type="submit" id="termsInsert">갱신하기</button>
		...
		var oEditors = [];
		   ...
		   $('#termsInsert').click(function() {
			   	document.getElementById("termsTitle").removeAttribute("disabled");
			   	document.getElementById("termsRequiredFl").removeAttribute("disabled");
			   	document.getElementById("termsDeleteFl").removeAttribute("disabled");
			    
				oEditors.getById["termsContent"].exec("UPDATE_CONTENTS_FIELD", []);	 	
		    	termsRenewForm.submit();
		    });
