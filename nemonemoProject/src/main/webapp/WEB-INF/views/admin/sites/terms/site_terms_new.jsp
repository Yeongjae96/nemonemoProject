							...
							<form id="termsForm" method="POST">
								<div class="form-group form-float">
									...
									<div class="form-group form-float" style="margin-top: 30px;">
										<label class="form-label">약관 항목</label> <select
											class="selectpicker" id="termsTitle" name="termsTitle">
											<option value="S">이용약관</option>
											<option value="P">개인정보처리방침</option>
											<option value="L">위치기반서비스 이용약관</option>
										</select>
									</div>
								</div>
								<div class="form-group form-float">
									<div class="form-line">
										<label class="form-label">등록자 ID(추후 세션으로 대체할 예정)</label> <input
											type="text" class="form-control" id="adminRegId"
											name="adminRegId" required>
									</div>
								</div>
								<div class="form-group form-float" style="margin-top: 30px;">
									<label class="form-label">필수 여부</label> <select
										class="selectpicker" id="termsRequiredFl"
										name="termsRequiredFl">
										<option value="Y">Y</option>
										<option value="N">N</option>
									</select>
								</div>
								<div class="form-group form-float" style="margin-top: 30px;">
									<label class="form-label">노출 여부</label> <select
										class="selectpicker" id="termsDeleteFl" name="termsDeleteFl">
										<option value="Y">Y</option>
										<option value="N">N</option>
									</select>
								</div>
								<div class="form-group form-float">
									<textarea cols="120" rows="20" name="termsContent"
										id="termsContent"></textarea>
								</div>

								<button class="btn btn-primary waves-effect" type="submit"
									id="termsInsert">등록하기</button>
							</form>
						</div>
					</div>
				</div>
