						...
						<div class="body">
							<form id="bannerEditForm" method="POST" action="edit.mdo">
								...
								<div class="form-group form-float" style="margin-top: 30px;">
                                    ...
                                    <select class="selectpicker" id="bannerDelFl" name="bannerDelFl">
                                        <option value="Y" <c:if test="${bannerVO.bannerDelFl eq 'Y'}">selected</c:if>>Y</option>
                                        <option value="N" <c:if test="${bannerVO.bannerDelFl eq 'N'}">selected</c:if>>N</option>
                                    </select>
