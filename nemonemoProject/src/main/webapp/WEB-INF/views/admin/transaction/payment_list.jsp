...
<!-- 페이지 CSS -->
<link rel="stylesheet" href="<c:url value="/resources/css/admin/transaction/order_list.css"/>">

<!-- 페이지 JS -->
<script src="<c:url value="/resources/js/admin/transaction/order_list.js"/>"></script>
                                    ...
                                    <table id="mem-care-list"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>상점1102호</td>
                                                <td>상점55호</td>
                                                <td>2020/07/21 <span class="label label-warning">New</span> </td>
                                                <td>미완료</td>
