		...
		<div class="purchases_block">
			<div class="purchases_body">
				...
				<div class="purchases_body_main">
					...
					<input onclick="changevalue()" type="button" value=""
						id="purchaseselect"></input>
					<!-- 쿠폰-->
						...
						<div class="purchases_terms_body">
							<div class="purchases_terms_totalagreement">
								<input type="checkbox" id="agreement"
									...
									onclick="changeall_argument()">주문 정보 및 서비스 이용약관 모두 동의 </label>
							</div>
					...
					<section class="purchases_buy_section">
						<button class="purchases_buy" type="button" id="buybtn" disabled
							onClick="location.href='https://www.naver.com/'"></button>
					</section>
					<input type="hidden" value=0 id="pullPrice">
					<section class="purchases_footer">"번개장터_컨시어지" 상점의 판매상품을
						제외한 모든 상품들에 대하여, 번개장터㈜는 통신판매중개자로서 중고거래마켓 번개장터의 거래 당사자가 아니며, 입점판매자가
						등록한 상품정보 및 거래에 대해 책임을 지지 않습니다.</section>
				</div>
