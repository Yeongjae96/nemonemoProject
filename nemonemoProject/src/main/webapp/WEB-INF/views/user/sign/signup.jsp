...
<!-- 페이지 CSS  -->
<link rel="stylesheet" href="<c:url value="/resources/css/user/sign/signup.css"/>">
        ...
        <div class="signin-form">
            ...
            <div class="signin-box">
                <div class="info-input-outline">
                    <div class="signin-common-margin">
                        <div class="input-box">
                            ...
                            <input type="text" placeholder="휴대폰 번호(숫자만 허용)" autocomplete="username" value="" id="phoneNumber" required>
                ...
                <div class="info-input-outline">
                    <div class="signin-common-margin">
                        <div class="input-box">
                            ...
                            <input type="password" placeholder="비밀번호 *8~16자의 영문, 숫자, 특수문자 사용"
                                autocomplete="new-password" value="" id="passInput">
                        </div>
                        <div class="veridation-msg hide" id="passMsg">
                        </div>
                    </div>
                    <div class="signin-common-margin">
                        <div class="input-box">
                            <div class="signin-img"><img alt="비밀번호 확인 Input 아이콘"
                                    src="data:image/png;base64,"
                                    width="16" height="20"></div><input type="password" placeholder="비밀번호 확인"
                ...
                <div class="info-input-outline">
                    <div class="signin-common-margin">
                        <div class="input-box">
                            <div class="signin-img"><img alt="이메일 Input 아이콘"
                                    ...
                                    width="18" height="15"></div><input type="text" placeholder="이메일(비밀번호 분실시 사용)"
                                value="">
                        </div>
                    </div>
                </div>
                            ...
                            <form class="select-form">
                                <div class="select-for-recommend">
                                    <div class="gender-check">
                                        ...
                                        <label for="남성">
                                            <input id="남성" type="radio" value="0" name="gender">남성</label>
                                        <label for="여성">
                                            <input id="여성" type="radio" value="0" name="gender">여성</label>
                                    </div>
                                    <div class="birth-year">
                                        <div class="i-img">
                                            <i class="fas fa-birthday-cake"></i>
                                        </div>
                                        <label class="born-year">태어난 해 :</label>
                                        <select name="select-year">
                                            <option value="" selected="selected">선택</option>
                                            <option value="1991">1991</option>
                                            <option value="1992">1992</option>
                                        </select>
                                        <label class="">거래지역 :</label>
                    ...
                    <div class="check-padding">
                        <div class="check-margin">
                            ...
                            <div class="hide-term hide1" id="term-1">
                                <div class="terms-second-scroll"><iframe title="번개장터 위치기반서비스 이용약관"
                        ...
                        <div class="check-margin">
                            <div class="terms-check-box">
                                ...
                                <div class="checkbox-info"><span class="mandatory">(필수)</span>개인정보 처리 방침 동의
                                </div><button id="show2" class="show-btn show-bt2"><img
                                        src="data:image/png;base64,"
                                        width="20" height="20" alt="회원가입 아이콘"></button>
                            </div>
                        ...
                        <div class="check-margin">
                            <div class="terms-check-box">
                                ...
                                <div class="checkbox-info">
                                    <span class="suggest">(선택)</span>위치기반서비스 동의</div>
