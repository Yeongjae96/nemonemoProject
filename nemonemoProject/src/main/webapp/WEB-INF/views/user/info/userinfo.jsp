...
<body>
	<div class="signin-all">
		<form method="post" action="updateUser.do" name="updateUser"
					...
					<div class="info-input-outline">
						...
						<div class="signin-common-margin">
							<div class="input-box">
								...
								<input type="password" value="" id="userPw" name="userPw"
									placeholder="비밀번호 8자이상 16자이하 입력해주세요">
							</div>
						</div>
						...
						<div class="signin-common-margin">
							<div class="input-box">
								...
								<input type="text" value="${user.userPhone}" id="userPhone"
									name="userPhone">
							</div>
						</div>
						<div class="signin-common-margin">
							<div class="input-box">
								...
								<input type="text" value="${user.userAccount}" id="userAccount"
									name="userAccount">
							</div>
						</div>
							...
							<div class="signin-common-margin">
								<div class="input-box">
									<input class="form-control"
										...
										name="userZipcode" id="zipcodeInput" type="text"
										value="${user.userZipcode}" readonly="readonly">
							...
							<div class="signin-common-margin">
								<div class="input-box">
									<input type="text" placeholder="주소를 검색해주세요" name="userAddress1"
										id="address1Input" value="${user.userAddress1}"
										readonly="readonly">
								</div>
							</div>
