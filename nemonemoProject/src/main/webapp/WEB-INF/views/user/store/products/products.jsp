...
<!-- 									<button class="product_name">상점명 수정</button> -->
							...
							<div class="product_all20">
								<div class="product_all21">
									...
									<div class="product_all22">2698일 전</div>
								</div>
				...
				<div class="sc-dCVVYJ dYImYF">
					<div class="sc-vBKru hEaZqn">
						<div class="product_all56">
							...
							<a class="product_all63" href="/shop/${storeVO.storeNo }/reviews.do">상점후기 <span
								class="product_all64">0</span></a>
							<!-- <a
                            class="product_all65" href="/store/782819/followings">팔로잉 <span
                                class="product_all66">0</span></a><a class="product_all67"
                            href="/store/782819/followers">팔로워 <span class="product_all68">0</span></a> -->
						</div>
					</div>
