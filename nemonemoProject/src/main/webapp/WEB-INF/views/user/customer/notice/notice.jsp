		...
		<div class="notice-body">
			<div class="notice-body-div">
				<nav class="notice-nav">
						<a class="notice-nav-selected" href="notice.html">공지사항</a>
						<a class="notice-nav-not-selected" href="policy.html">운영정책</a>
						<a class="notice-nav-not-selected" href="notice1.html">자주묻는 질문</a>
