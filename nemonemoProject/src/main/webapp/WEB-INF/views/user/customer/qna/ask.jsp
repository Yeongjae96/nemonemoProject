		...
		<div class="qna-body">
			<div class="qna-body2">
				<main class="qna-main">
					...
					<hr style="border:1px;">
					<nav class="qna-nav">
						<a class="qna-nav-selected" href="#">1:1 상담하기</a>
						<a class="qna-nav-not-selected" href="#">상담내역</a>
					</nav>
				<form method="post" action ="new.do">
					<div class="qna-contents">
							...
							<div class=" css-2b097c-container">
								<div class="qna-contents-selbox-box">
									<div class="css-1hwfws3">
										...
										<!-- 대분류 -->
										<c:forEach var="qnaCategory" items="${qnaCategoryParentList}">
							...
							<div class=" css-2b097c-container">
								<div class="qna-contents-selbox-box">
									<div class=" css-1hwfws3">
										...
										<!-- 대분류 -->
										<c:forEach var="qnaCategory" items="${qnaCategoryNameList}">
											<option value ="${qnaCategory.qnaCategoryName}">${qnaCategory.qnaCategoryName}</option>
										</c:forEach> 
										</select>
									</div>
						...
						<textarea rows="20" class="qna-contents-textarea">${qnaContent}</textarea>
