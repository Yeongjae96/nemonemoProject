...
$(function () {
    ...
    $('.coupon-upd-btn').click(function() {
		const couponNo = $(this)[0].dataset.couponno;
		window.location.href="edit.mdo?couponNo="+couponNo;
	});
...
(function deleteModal() {
   ...
   $('#coupon-del-btn').click(function() {
	   selectedCouponNo = $(this).data('couponsq');
      console.log("선택한거 : " + selectedCouponNo);
      
      $('.modal-title > span').text(`${selectedCouponNo}번`);
   });

   $('#coupon-del').click(function() {
      $.ajax({
         url: 'delete.mdo',
         method: 'POST',
         data: {
